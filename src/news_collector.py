...
아래 규칙을 반드시 지켜서 요약해줘:
- "회의를 개최했다", "논의했다" 같은 뻔한 내용 금지
- 구체적인 수치, 인물명, 정책명을 포함할 것
- 각 줄이 서로 다른 핵심 정보를 담을 것
- "누가 + 무엇을 + 왜/어떻게" 구조로 작성

1. (가장 중요한 핵심 내용 - 구체적 사실 중심)
2. (두 번째 핵심 내용 - 배경이나 원인)
3. (세 번째 핵심 내용 - 영향이나 전망)
